<div {{ $attributes->merge(['class' => 'flex items-center gap-3']) }}>
    ...
    <a href="https://wa.me/?text={{ urlencode($event->name . ' - ' . $event->date->format('M j, Y') . ' at ' . $event->venue->name . ' - ' . request()->url()) }}"
       target="_blank"
       rel="noopener noreferrer"
       class="p-2 rounded-full bg-green-600 text-white hover:bg-green-700 transition-colors"
    ...
    <a href="https://www.instagram.com/"
       target="_blank"
       rel="noopener noreferrer"
       class="p-2 rounded-full bg-pink-600 text-white hover:bg-pink-700 transition-colors"
       aria-label="Open Instagram">
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5a4.25 4.25 0 0 0 4.25 4.25h8.5a4.25 4.25 0 0 0 4.25-4.25v-8.5a4.25 4.25 0 0 0-4.25-4.25h-8.5zM17.5 6.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5zM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm0 1.5A3.5 3.5 0 1 0 12 15.5 3.5 3.5 0 0 0 12 8.5z"/>
        </svg>
    </a>
