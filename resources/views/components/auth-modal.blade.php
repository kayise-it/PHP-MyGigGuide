            ...
            <div class="p-8" @click.stop>
                ...
                <div x-show="formStep === 'social'" x-cloak="" class="space-y-3">
                    <x-firebase-google-sign-in
                        ...
                        class="w-full inline-flex justify-center items-center py-3 px-4 border-2 border-transparent font-medium rounded-xl gap-2.5 text-sm text-white bg-[linear-gradient(45deg,#6666FF,#dd5555_90%,#fff)] transition-all ease-out duration-200 hover:scale-[1.02] shadow-lg shadow-purple-700/30"
                    />
