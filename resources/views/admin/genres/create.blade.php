...
@section('title', 'Create Genre - Admin Panel')
@section('description', 'Create a new genre.')
...
<div class="p-6">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Create New Genre</h1>
    </div>
        ...
        <form method="POST" action="{{ route('admin.genres.store') }}">
            ...
            <div class="mb-6">
                ...
                <textarea id="description" 
                          ...
                          placeholder="Enter a brief description of this genre...">{{ old('description') }}</textarea>
                @error('description')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
