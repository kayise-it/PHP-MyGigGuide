...
/// Listener poll block — shared by main-app station detail and flavor radio tabs.
...
class _StationPollSectionState extends State<StationPollSection> {
  ...
  Future<void> _load() async {
    ...
    try {
      final poll = await _api.fetchPoll(widget.station.pollContext);
      if (!mounted) return;
      setState(() {
        _poll = poll;
        _loading = false;
  ...
  Widget build(BuildContext context) {
    final accent = widget.station.accentColor;
